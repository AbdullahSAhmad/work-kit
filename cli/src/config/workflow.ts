...
const WORKFLOW_MATRIX: Record<Classification, Record<string, InclusionRule>> = {
  "bug-fix": {
    ...
    "review/scope": "YES", "review/self-review": "YES", "review/security": "skip", "review/performance": "skip",
  ...
  refactor: {
    ...
    "build/setup": "skip", "build/implement": "YES", "build/commit": "YES",
    "test/verify": "YES", "test/browser": "skip", "test/e2e": "skip", "test/validate": "skip",
    "review/scope": "YES", "review/self-review": "YES", "review/security": "skip", "review/performance": "YES",
    "review/compliance": "skip", "review/fix": "YES", "review/handoff": "YES",
    "deploy/merge": "YES", "deploy/monitor": "optional", "deploy/remediate": "optional",
  ...
  feature: {
    ...
    "review/scope": "YES", "review/self-review": "YES", "review/security": "YES", "review/performance": "skip",
  ...
  "large-feature": {
    ...
    "review/scope": "YES", "review/self-review": "YES", "review/security": "YES", "review/performance": "YES",
    "review/compliance": "YES", "review/fix": "YES", "review/handoff": "YES",
    "deploy/merge": "YES", "deploy/monitor": "optional", "deploy/remediate": "optional",
    "wrap-up/summary": "YES", "wrap-up/knowledge": "YES",
  },
